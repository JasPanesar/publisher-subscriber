<cfcomponent output="false">
		...
		<cfloop query="local.assignedSiteQry">
			...
			<cfloop list="#variables.validPublisherTypes#" index="local.type">
				...
				<cfset saveAttribute( 
							...
							name: "subscribeToAllChildPages",
							label: "Subscriber to all children pages?",
							type: "RadioGroup",
							optionList: "No^Yes",
				...
				<cfset saveAttribute( 
							extendSet: local.extendSet, 
							name: "autoUpdateSubscriberPage",
							label: "Auto update this page whenever the publisher page is updated?",
							type: "RadioGroup",
							optionList: "No^Yes",
							optionLabelList: "No^Yes",
							defaultValue: "No"
	...
	<cffunction name="saveExtendSet" returntype="any" access="private" output="false">
		...
		<cfset extendSet.setContainer(arguments.container)>
		<!--- save the extendset --->
